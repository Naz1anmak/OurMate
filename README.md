...
- **В беседе:** бот постит карточку напоминания с единой кнопкой **«Подписаться / Отписаться»** — любой участник тогглит личную подписку, результат приходит персональным всплывающим уведомлением, а в карточке обновляется счётчик участников. В момент срабатывания все подписчики упоминаются в ответном сообщении
