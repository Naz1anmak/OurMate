...
- Ограничение длины ответов: LLM-ответ режется по видимой длине (`_trim_html`, 4050 символов при жёстком потолке 4700 с учётом HTML-тегов), вывод логов — по 4000
