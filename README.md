...
- **Ручное добавление** другого человека (только автор списка или владелец): «добавь @ник в список …» — резолв по reply / выбору из выпадашки (`text_mention`) / `@username` / «Фамилии Имени» из ростера
