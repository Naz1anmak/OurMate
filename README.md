...
- **Неофициальный** — имена как в Telegram (профиль/`@ник`), кликабельные меншены; **официальный** — настоящие «Фамилия Имя» из ростера дней рождения (для передачи, например, преподавателю). Нет в ростере → бот попросит ввести имя ответом на сообщение (force-reply)
