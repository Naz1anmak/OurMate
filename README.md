...
- Ставить **напоминания на естественном языке** («напомни в пятницу в 18 про созвон»): в беседе — с кнопкой «Напомни и мне» для подписчиков; в ЛС — персонально
...
- **В беседе:** бот постит карточку напоминания с кнопкой **«Напомни и мне»** — любой участник может подписаться. В момент срабатывания все подписчики упоминаются в ответном сообщении
...
### 7. **Гибкая конфигурация через `.env`**
