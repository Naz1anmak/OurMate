...
- **Уведомлять владельца в личку** о следующем дне рождения
...
- Читает `data/birthdays.json` и каждый день в заданное время шлёт поздравление в беседу
- Поздравляет именинников по шаблону из `.env`
- После поздравления уведомляет владельца о следующем дне рождения
