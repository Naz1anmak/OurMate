...
async def cmd_start(message: types.Message):
    ...
    if message.from_user.id == OWNER_CHAT_ID:
        welcome_text = (
            ...
            "• <code>обнови расписание</code> — Принудительно обновить расписание и закреп\n\n"
            "<b>Список для уведомлений:</b>\n"
            "• <code>пинг</code> — Панель списка в беседе (вступить/выйти кнопками)\n"
            "• <code>@all</code> — Позвать всех из списка (в беседе, без упоминания бота)\n"
            "• <code>списки</code> — Общие списки/очереди (запись кнопкой, уточнение реплаем)\n\n"
