...
VOICE_NOTE = (
    ...
    "Не цитируй слова в кавычках — перескажи своими словами, как сказал бы вслух "
    "(не «ты» да «родной», а «не надо мне тыкать и звать родным»). "
    "Для живости можно вставить 1–2 звука там, где так сказал бы человек: (chuckle) — смешок, "
    "(emm) — «э-э» перед мыслью; не в самом начале реплики. Изредка пауза в секундах: <#0.25#> — короткая заминка, <#0.5#> — обычная, <#1#> — многозначительная. Другие звуки "
...
GROUP_SPEAKERS_NOTE = (
    "Это общий чат в Telegram: пишут разные люди, перед каждой репликой стоит подпись автора "
    "(«Имя: текст») — это метка из Telegram, а не обязательно настоящее имя. Отвечай только автору "
    "последнего сообщения: оно важнее всего, прошлые реплики — лишь фон, не возвращайся к ним и не "
    "переноси на автора то, что говорили другие. По имени не обращайся, если подпись не похожа на "
    "настоящее имя (ник, набор букв, эмодзи); род выбирай по имени, а если он неясен — говори без "
    "рода. Ответ подписью не начинай. Замечание про обращение на «Вы» и по имени-отчеству делай "
    "только на явную фамильярность в твой адрес и не повторяй, если уже делал."
)
