...
CREATE_SCHEMA = {
    ...
    "function": {
        ...
        "description": (
            ...
            "«напомнишь через 10 минут воды попить?»). Относительное время («через две минуты», "
            "«через час», «через полчаса») сам посчитай от контекста времени. "
            "Время передавай в ISO 8601 с часовым поясом. "
