...
GET_SCHEDULE_SCHEMA = {
    ...
    "function": {
        ...
        "description": (
            ...
            "пары по RUZ (включая чужие параллели потока); teachers — преподаватели. Для «с кем у "
            "нас занятие» бери lesson_groups (за вычетом наших групп), для «кто ведёт» — teachers."
        ),
        "parameters": {
            "type": "object",
            "properties": {
...
FIND_CLASSES_BY_SUBJECT_SCHEMA = {
    ...
    "function": {
        ...
        "description": (
            ...
            "для вопросов «с кем» и «кто ведёт»."
        ),
        "parameters": {
            "type": "object",
            "properties": {
