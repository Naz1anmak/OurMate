...
def prepare_speech_text(text: str) -> str:
    """Готовит текст к озвучке: тире между словами MiniMax проглатывает — ставим короткую паузу;
    слова в кавычках он выделяет интонацией и паузами — кавычки убираем."""
    text = re.sub(r"[«»„“”\"]", "", text)
